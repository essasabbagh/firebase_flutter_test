import 'package:animation_test/poll.dart';
import 'package:animation_test/shared/firebase_authentication.dart';
            ...
            IconButton(
              ...
              onPressed: () {
                auth.logout().then((value) {
                  if (value)
                    setState(() => _message = 'User Logged Out');
                  else
                    setState(() => _message = 'Unable to Log Out');
                });
              },
            ),
          ],
              ...
              onPressed: () {
                ...
                if (_isLogin) {
                  ...
                  auth
                      ...
                      .then((value) {
                    if (value == null) {
                      setState(() => _message = 'Registration Error');
                    } else {
                      userId = value;
                      setState(() =>
          ...
          child: ElevatedButton(
            ...
            onPressed: () {
              auth.loginWithGoogle().then((value) {
                if (value == null) {
                  setState(() => _message = 'Google Login Error');
                } else {
                  setState(() => _message =
